...
class Addendum(UUIDMixin, Base):
    ...
    uuid = UUIDMixin.uuid # necessary for relationship definition, below
    ...
    # many-to-many mapping between Addenda
    ...
    # tree structure of Addenda
    def getChildren(self):
        return [a_tree_node.addendum for a_tree_node in self.a_tree_nodes]
