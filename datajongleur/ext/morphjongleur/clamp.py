...
import mrj.util.auto_string.Auto_string
...
class VClamp(mrj.model.clamp.VClamp, Identity):
    ...
    vclamp_key      = sqlalchemy.Column('vclamp_key', sqlalchemy.Integer, sqlalchemy.ForeignKey(BB_PREFIX + 'identities.uuid'), primary_key=True),
...
class PatternClamp(mrj.model.clamp.PatternClamp, Identity):
    ...
    patternclamp_key=   sqlalchemy.Column('patternclamp_key', sqlalchemy.Integer, sqlalchemy.ForeignKey(BB_PREFIX + 'identities.uuid'), primary_key=True)
    experiment_key  = sqlalchemy.Column('experiment_key', sqlalchemy.Integer, sqlalchemy.ForeignKey(PREFIX + 'experiments.experiment_key'))
    morphology_key  = sqlalchemy.Column('morphology_key', sqlalchemy.Integer, sqlalchemy.ForeignKey(PREFIX + 'morphologies.morphology_key'))
    compartment_key = sqlalchemy.Column('compartment_key', sqlalchemy.Integer, sqlalchemy.ForeignKey(PREFIX + 'compartments.compartment_key'))
    compartment_id  = sqlalchemy.Column('compartment_id', sqlalchemy.Integer)
...
class Clamp_groups(mrj.util.auto_string.Auto_string, Identity):
    ...
    iclamp_group_key= sqlalchemy.Column('iclamp_group_key', sqlalchemy.Integer, sqlalchemy.ForeignKey(BB_PREFIX + 'identities.uuid'), primary_key=True)
...
class Clamps_clamp_groups_map(Base):
    ...
    iclamp_key      = sqlalchemy.Column('iclamp_key', None, sqlalchemy.ForeignKey(PREFIX + 'sinusclamp.iclamp_key'), sqlalchemy.ForeignKey(BB_PREFIX + 'identities.uuid'), primary_key=True)
    iclamp_group_key= sqlalchemy.Column('iclamp_group_key', None, sqlalchemy.ForeignKey(PREFIX + 'iclamps_groups.iclamp_group_key'), sqlalchemy.ForeignKey(BB_PREFIX + 'identities.uuid'), primary_key=True)
